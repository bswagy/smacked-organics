...
const KIT = [
  ...
  {id:'beanie', name:'beanie', price:28, svg:GARMENT_BEANIE, colors:['#0E0E0E'], colorImages:{'#0E0E0E':['beanie-black-front.png']}, description:'ribbed knit beanie, mid-weight and stretchy for a snug, all-day fit. finished with a subtle woven tag.'},
];
