...
const PRODUCTS = [
  ...
  {id:1, name:'smacked tee', price:38, colors:['#FF2D78','#F3EFEA','#241B30','#6B3FA0'], cat:'tees', images:[], video:''},
  {id:2, name:'organics hoodie', price:88, colors:['#6B3FA0','#F3EFEA','#241B30','#FF2D78'], cat:'hoodies', images:[], video:''},
  {id:3, name:'blackout crew', price:60, colors:['#F3EFEA','#241B30','#6B3FA0','#FF2D78'], cat:'hoodies', images:[], video:''},
  {id:4, name:'og tank', price:32, colors:['#FF2D78','#241B30','#F3EFEA','#6B3FA0'], cat:'tees', images:[], video:''},
  {id:5, name:'neon coach jacket', price:115, colors:['#6B3FA0','#FF2D78','#F3EFEA','#241B30'], cat:'outerwear', isNew:true, images:[], video:''},
  {id:6, name:'pocket tee', price:34, colors:['#F3EFEA','#FF2D78','#6B3FA0','#241B30'], cat:'tees', isNew:true, images:[], video:''},
];
