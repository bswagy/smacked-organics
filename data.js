...
const KIT = [
  {id:'hoodie', name:'hoodie', price:88, svg:GARMENT_HOODIE, colors:['#F3EFEA','#6B3FA0','#FF2D78','#241B30'], description:'heavyweight fleece hoodie with a boxy fit and dropped shoulder. brushed interior for warmth, kangaroo pocket, ribbed cuffs and hem.'},
...
const ORGANICS = [
  {id:101, name:'rolling papers', price:8, colors:['#F3EFEA','#241B30','#6B3FA0','#FF2D78'], svg:ORGANICS_PAPERS, cat:'accessories', description:'slow-burning, natural unbleached papers. 32 leaves per pack, sized for an even, consistent roll.'},
  {id:102, name:'grinder', price:24, colors:['#6B3FA0','#241B30','#F3EFEA','#FF2D78'], svg:ORGANICS_GRINDER, cat:'accessories', description:'4-piece aircraft-grade aluminum grinder with a pollen screen and built-in catcher. sharp diamond teeth for a fine, even grind.'},
  {id:103, name:'rolling tray', price:32, colors:['#241B30','#6B3FA0','#FF2D78','#F3EFEA'], svg:ORGANICS_TRAY, cat:'accessories', description:'raised-edge metal tray with a smooth non-stick finish. compact size, easy to wipe clean.'},
  {id:104, name:'stash jar', price:18, colors:['#F3EFEA','#6B3FA0','#241B30','#FF2D78'], svg:ORGANICS_JAR, cat:'accessories', description:'airtight glass jar with a smell-proof seal. UV-resistant tint to help keep contents fresh longer.'},
  {id:105, name:'torch lighter', price:14, colors:['#FF2D78','#241B30','#6B3FA0','#F3EFEA'], svg:ORGANICS_LIGHTER, cat:'accessories', description:'refillable windproof torch lighter with an adjustable flame. compact, pocket-friendly build.'},
  {id:106, name:'ashtray', price:16, colors:['#241B30','#F3EFEA','#FF2D78','#6B3FA0'], svg:ORGANICS_ASHTRAY, cat:'accessories', description:'weighted ceramic ashtray with built-in rest grooves. easy to clean, built to last.'},
];
