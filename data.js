...
const ORGANICS = [
  ...
  {id:104, name:'stash jar', price:18, colors:['#F3EFEA','#6B3FA0','#241B30','#FF2D78'], svg:ORGANICS_JAR, cat:'accessories', images:[], video:'', description:'airtight glass jar with a smell-proof seal. UV-resistant tint to help keep contents fresh longer.'},
