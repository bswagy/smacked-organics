...
const KIT = [
  ...
  {id:'hoodie', name:'hoodie', price:88, svg:GARMENT_HOODIE, colors:['#241B30','#3D1A23'], colorImages:{'#241B30':['hoodie-black-front.png'], '#3D1A23':['hoodie-maroon-front.png']}, description:'heavyweight fleece hoodie with a boxy fit and dropped shoulder. brushed interior for warmth, kangaroo pocket, ribbed cuffs and hem.'},
  {id:'beanie', name:'beanie', price:28, svg:GARMENT_BEANIE, colors:['#0E0E0E'], colorImages:{'#0E0E0E':['beanie-black-front.png', 'beanie-black-back.png']}, description:'ribbed knit beanie, mid-weight and stretchy for a snug, all-day fit. finished with a subtle woven tag.'},
];
...
const PRODUCTS = [
  ...
  {id:7, name:'smacked sweatpants', price:68, colors:['#241B30','#3D1A23'], colorImages:{'#241B30':['sweatpants-black-front.png'], '#3D1A23':['sweatpants-maroon-front.png']}, cat:'bottoms', images:[], video:'', description:'relaxed, wide-leg sweatpants with a raw-cut hem and drawstring waist. heavyweight fleece, matches the hoodie.'},
  {id:8, name:'oversized logo hoodie', price:92, colors:['#202020'], colorImages:{'#202020':['hoodie-oversized-front.jpg']}, cat:'hoodies', images:[], video:'', description:'vintage-washed, oversized-fit hoodie with a distressed, cracked-print SMACKED logo across the chest. heavyweight fleece, dropped shoulder.'},
  {id:9, name:'Vintage wash + small logo', price:68, colors:['#202020'], colorImages:{'#202020':['sweatpants-oversized-front.jpg']}, cat:'bottoms', images:[], video:'', description:'vintage-washed, wide-leg sweatpants with a small SMACKED hip print. heavyweight fleece, drawstring waist, matches the oversized hoodie.'},
  {id:10, name:'smacked zip hoodie', price:98, colors:['#202020'], colorImages:{'#202020':['zip-hoodie-black-front.png']}, cat:'hoodies', images:[], video:'', description:'full-zip hoodie with the SMACKED arch logo across the chest. heavyweight fleece, relaxed boxy fit.'},
  {id:11, name:'vertical logo sweatpants', price:68, colors:['#202020'], colorImages:{'#202020':['sweatpants-vertical-front.png']}, cat:'bottoms', images:[], video:'', description:'relaxed, straight-leg sweatpants with a large vertical SMACKED print down the leg. heavyweight fleece, raw-cut hem, matches the zip hoodie.'},
  {id:12, name:'smacked dragon tee', price:38, colors:['#241B30'], colorImages:{'#241B30':['tee-dragon-front.jpg']}, cat:'tees', images:[], video:'', description:'vintage-washed, boxy cropped tee with the SMACKED badge logo on the chest. garment-washed heavyweight cotton.'},
  {id:13, name:'smacked dragon sweatpants', price:68, colors:['#241B30'], colorImages:{'#241B30':['sweatpants-dragon-front.jpg']}, cat:'bottoms', images:[], video:'', description:'wide-leg sweatpants with the SMACKED badge logo on the hip and thorned flame graphics running down each leg. heavyweight fleece, drawstring waist, matches the dragon tee.'},
  {id:14, name:'smacked organics trucker hat', price:32, colors:['#0E0E0E'], colorImages:{'#0E0E0E':['hat-front.png', 'hat-back.png']}, cat:'hats', isNew:true, images:[], video:'', description:'structured trucker hat with a mesh back and snapback closure. embroidered SMACKED Organics script on the front panel, mountain-eye emblem embroidered on the back.'},
  {id:15, name:'smacked star tee', price:38, colors:['#F3EFEA'], colorImages:{'#F3EFEA':['tee-white-back.jpg']}, cat:'tees', images:[], video:'', description:'oversized white tee with the SMACKED star wordmark printed across the upper back. heavyweight cotton, relaxed boxy fit.'},
  {id:16, name:'smacked collegiate tee', price:38, colors:['#0E0E0E'], colorImages:{'#0E0E0E':['tee-collegiate-black-front.jpg']}, cat:'tees', images:[], video:'', description:'boxy cropped tee with the collegiate SMACKED ORGANICS logo on the chest. small batch, heavyweight cotton.'},
  {id:17, name:'smacked bodega tee', price:38, colors:['#F3EFEA'], colorImages:{'#F3EFEA':['tee-bodega-front.jpg', 'tee-bodega-back.jpg']}, cat:'tees', images:[], video:'', description:'off-white tee with a small SMACKED ORGANICS chest logo up front and a full storefront graphic across the back.'},
  {id:18, name:'smacked star sweatpants', price:68, colors:['#F3EFEA'], colorImages:{'#F3EFEA':['sweatpants-star-white-front.jpg']}, cat:'bottoms', images:[], video:'', description:'relaxed white sweatpants with a small star-SMACKED logo on the hip. heavyweight fleece, raw-cut hem.'},
  {id:19, name:'are you smacked sweatpants', price:68, colors:['#858585'], colorImages:{'#858585':['sweatpants-worldwide-front.png']}, cat:'bottoms', images:[], video:'', description:'heather grey wide-leg sweatpants with the SMACKED shooting-star logo and bold "are you smacked yet?" leg graphics. matches the hoodie.'},
  {id:20, name:'are you smacked hoodie', price:92, colors:['#858585'], colorImages:{'#858585':['hoodie-worldwide-front.jpg']}, cat:'hoodies', isNew:true, images:[], video:'', description:'heather grey cropped hoodie with the SMACKED shooting-star logo across the chest and "are you smacked yet?" printed down each sleeve.'},
];
