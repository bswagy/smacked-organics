...
const PRODUCTS = [
  ...
  {id:9, name:'oversized logo sweatpants', price:68, colors:['#202020'], colorImages:{'#202020':['sweatpants-oversized-front.jpg']}, cat:'bottoms', images:[], video:'', description:'vintage-washed, wide-leg sweatpants with a small SMACKED hip print. heavyweight fleece, drawstring waist, matches the oversized hoodie.'},
  ...
  {id:14, name:'smacked organics trucker hat', price:32, colors:['#0E0E0E'], colorImages:{'#0E0E0E':['hat-front.png', 'hat-back.png']}, cat:'hats', images:[], video:'', description:'structured trucker hat with a mesh back and snapback closure. embroidered SMACKED Organics script on the front panel, mountain-eye emblem embroidered on the back.'},
  ...
  {id:19, name:'smacked worldwide sweatpants', price:68, colors:['#858585'], colorImages:{'#858585':['sweatpants-worldwide-front.png']}, cat:'bottoms', images:[], video:'', description:'heather grey wide-leg sweatpants with the SMACKED Worldwide Brand shooting-star logo and bold vertical leg graphics. matches the worldwide hoodie.'},
  {id:20, name:'smacked worldwide hoodie', price:92, colors:['#858585'], colorImages:{'#858585':['hoodie-worldwide-front.jpg']}, cat:'hoodies', images:[], video:'', description:'heather grey cropped hoodie with the SMACKED Worldwide Brand shooting-star logo across the chest and matching sleeve graphics.'},
];
